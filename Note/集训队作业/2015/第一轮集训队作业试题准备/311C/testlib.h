...
struct InStream
{
    ...
    long long readLong(long long minv, long long maxv, const std::string& variableName = "",const std::string &L="",const std::string &R="");
	...
	int readInt(int minv, int maxv, const std::string& variableName = "",const std::string &L="",const std::string &R="");
    /* 
    ...
    double readReal(double minv, double maxv, const std::string& variableName = "",const std::string &L="",const std::string &R="");
    ...
    double readStrictReal(double minv, double maxv,
            ...
            const std::string& variableName = "",const std::string &L="",const std::string &R="");
    /* 
...
long long InStream::readLong(long long minv, long long maxv, const std::string& variableName,const std::string &L,const std::string &R)
{
...
int InStream::readInt(int minv, int maxv, const std::string& variableName,const std::string& L,const std::string& R)
{
    int result = readInt();
    ...
    {
        if (variableName.empty())
            quit(_wa, ("Integer " + vtos(result) + " violates the range [" + l + ", " + r + "]").c_str());
        else
            quit(_wa, ("Integer parameter [name=" + std::string(variableName) + "] equals to " + vtos(result) + ", violates the range [" + l + ", " + r + "]").c_str());
    }
...
double InStream::readReal(double minv, double maxv, const std::string& variableName,const std::string& L,const std::string& R)
{

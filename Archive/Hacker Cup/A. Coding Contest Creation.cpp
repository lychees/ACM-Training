        ...
        REP_1(o, 7){
            ...
            REP(j, 4){
                ...
                if (!i) t = a[0];
                    ...
                    if (j+o <= 3) t = a[i] - a[i-1];
                    else t = (a[i]+100) - a[i-1];
                }
                if ((j+o >= 4 || t <= o*10) && t >= o) checkMin(f[p][(j+o)%4], f[q][j]+o-1);
            }
        }
    }
    // ... 97 98 99 100
